...
class _HomePageState extends State<HomePage> {
  ...
  void _deleteSelectedAlbums() {
    ...
    setState(() {
      ...
      final sortedIndices = _selectedAlbums.toList()
  ...
  Future<void> _showCreateAlbumDialog() async {
          ...
          builder: (context, setStateInDialog) {
            void saveAlbum() {
              ...
              if (name.isEmpty) {
                setStateInDialog(() {
                  albumNameError =
                      "Please enter an album name (e.g., Month Year)";
                });
                return;
              }
              ...
              Navigator.pop(dialogContext, {'name': name, 'date': dateCreated});
            }
    ...
    if (result != null) {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Album "$name" created.')));
    }
  }
